...
export const ENV = {
  ...
  OPENAI_CV_MODEL: process.env.OPENAI_CV_MODEL ?? process.env.OPENAI_MODEL ?? "gpt-4o",
  OPENAI_MATCHING_MODEL: process.env.OPENAI_MATCHING_MODEL ?? process.env.OPENAI_MODEL ?? "gpt-4o",
  JWT_SECRET: process.env.JWT_SECRET ?? "dev-secret-change-in-prod",
  TOKEN_SECRET: process.env.TOKEN_SECRET ?? "dev-token-secret-change-in-prod",
